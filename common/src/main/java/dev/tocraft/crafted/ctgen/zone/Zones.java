...
public class Zones {
    ...
    public static void bootstrap(BootstapContext<Zone> context) {
        ...
        context.register(MOUNTAINS, new ZoneBuilder().setBiome(getBiome(context, Biomes.STONY_PEAKS)).setColor(new Color(130, 130, 130)).setHeight(50).setPerlinMultiplier(28).setCaveThreshold(0.7).build());
