...
import dev.tocraft.crafted.ctgen.xtend.placer.NoisePlacer;
...
public class Zones {
    ...
    public static void bootstrap(BootstapContext<Zone> context) {
        ...
        context.register(SNOWY_SLOPES, new ZoneBuilder().setBiome(getBiome(context, Biomes.SNOWY_SLOPES)).setColor(new Color(192, 192, 192)).setDirtBlock(Blocks.SNOW_BLOCK).setSurfaceBlock(Blocks.SNOW_BLOCK).setHeight(24).setTerrainModifier(20).setPixelWeight(1.5).build());
        context.register(SNOWY_MOUNTAINS, new ZoneBuilder().setBiome(getBiome(context, Biomes.JAGGED_PEAKS)).setColor(new Color(168, 168, 168)).setHeight(60).setTerrainModifier(28).setSurfaceBlock(Blocks.SNOW_BLOCK).build());
        ...
        // Eastern Continent
        context.register(PLAINS, new ZoneBuilder().setBiome(getBiome(context, Biomes.PLAINS)).setColor(new Color(57, 95, 57)).setHeight(6).setTerrainModifier(4).build());
        context.register(FOREST, new ZoneBuilder().setBiome(getBiome(context, Biomes.FOREST)).setColor(new Color(43, 70, 43)).setHeight(8).setTerrainModifier(6).build());
        context.register(HILLS, new ZoneBuilder().setBiome(getBiome(context, Biomes.WINDSWEPT_GRAVELLY_HILLS)).setColor(new Color(151, 151, 151)).setHeight(25).setTerrainModifier(18).build());
        context.register(MOUNTAINS, new ZoneBuilder().setBiome(getBiome(context, Biomes.STONY_PEAKS)).setColor(new Color(130, 130, 130)).setDirtBlock(Blocks.STONE).setSurfaceBlock(Blocks.STONE).setHeight(50).setTerrainModifier(28).build());
        ...
        context.register(BADLANDS, new ZoneBuilder().setBiome(getBiome(context, Biomes.BADLANDS)).setColor(new Color(84, 84, 56)).setDirtBlock(Blocks.RED_CONCRETE).setSurfaceBlock(Blocks.BROWN_CONCRETE).setHeight(18).setTerrainModifier(12).build());
        ...
        }, Blocks.BROWN_CONCRETE)).setHeight(28).setTerrainModifier(24).build());
        // General Water Biomes
        ...
        context.register(OCEAN, new ZoneBuilder().setBiome(getBiome(context, Biomes.OCEAN)).setColor(new Color(0, 42, 103)).setSurfaceBlock(Blocks.SAND).setHeight(-35).setTerrainModifier(16).setThresholdModifier(26).build());
